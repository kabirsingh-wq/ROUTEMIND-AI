...
DEFAULT_ORIGIN_DATA = os.getenv("DEFAULT_ORIGIN_DATA", "IN")
...
def clean_text(text: str) -> str:
    ...
    stop_words = [
        "flight", "flights", "tickets", "tickets", "trip", "travel",
...
def parse_route(query: str):
    ...
    if len(mentions) == 1:
           ...
           dep_iata = resolve_location_to_iata(DEFAULT_ORIGIN_DATA)
           return dep_iata, arr_iata
